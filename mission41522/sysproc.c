	...
	)
{
	...
	for (;;){
		...
		if (0 == stricmp(Line, "ver")) {
			...
			continue;
		} else if (0 == stricmp(Line,"help")){//在控制台中添加help命令
...
// TODO
//
fprintf(StdHandle, "mm:Secondary Page Table Mapping Information.\n");
fprintf(StdHandle, "ds:Test the disk scheduling algorithm.\n");
fprintf(StdHandle, "rr:Test time slot rotation scheduling.\n");
fprintf(StdHandle, "loop:Loop.\n");
fprintf(StdHandle, "suspend:Suspend the thread specified by ID.\n");
fprintf(StdHandle, "resume:Restore the thread specified by ID.\n");
fprintf(StdHandle, "pm:Statistics output physical storage information.\n");
fprintf(StdHandle, "vm:Statistics output information on the virtual address descriptor of the process specified by the process ID.\n");
...
fprintf(StdHandle, "dir:Output information about files in the root directory of the floppy disk.\n");
fprintf(StdHandle, "help:View console commands.\n");
